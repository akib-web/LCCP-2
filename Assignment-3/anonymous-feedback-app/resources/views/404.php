        ...
        <div class="mx-auto max-w-xl">
          <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
            <div class="mx-auto w-full max-w-xl text-center">
              <h1 class="block text-center font-bold text-2xl bg-gradient-to-r from-blue-600 via-red-500 to-red-400 inline-block text-transparent bg-clip-text">
                404! Not found</h1>
              <h3 class="text-gray-500 my-2">The request url has not been found!</h3>
            </div>
